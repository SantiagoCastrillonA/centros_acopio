...
return [
    ...
    'attributes'             => [
        ...
        'birthday'                 => 'cumpleaños',
        'body'                     => 'contenido',
        'cantidad_cubierta'        => 'cantidad ya recibida',
    ...
    'custom'                 => [
        'cantidad_cubierta'  => [
            'max' => 'Esa cantidad es demasiado grande. Revise si sobra algún dígito.',
        ],
        'cantidad_requerida' => [
            'max' => 'Esa cantidad es demasiado grande. Revise si sobra algún dígito.',
        ],
        ...
        'latitud'            => [
            'max' => 'La latitud va entre -90 y 90. Revise el número.',
            'min' => 'La latitud va entre -90 y 90. Revise el número.',
        ],
        'longitud'           => [
            'max' => 'La longitud va entre -180 y 180. En Colombia es negativa, por ejemplo -75.6811.',
            'min' => 'La longitud va entre -180 y 180. En Colombia es negativa, por ejemplo -75.6811.',
        ],
    ],
];
